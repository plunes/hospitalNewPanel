...
import { GET_USER_SPECIALITIES, UPDATE_PROCEDURE , REMOVE_SERVICE, ADD_PROCEDURE, SEARCH_PROCEDURE, GET_PROCEDURES, TO_ADD_SERVICES, SET_VARIANCE, REMOVE_SPECIALITY} from '../actions/types'
...
import  {  ret_procedures, update_params, remove_service, remove_service_ret, remove_service_loading,
   get_procedures_error, update_modified_procedures, to_add_services_ret, to_add_services_clr, set_variance_ret ,
    get_user_specialities_ret, get_user_specialities_loading, remove_speciality_ret, remove_speciality_loading}  from '../actions/catalogue_actions'
...
function* remove_service_saga(action) {
  try {
   let center_id = get_url_params('center')
...
const catalogue_saga  = [
   ...
   takeLatest(REMOVE_SERVICE, remove_service_saga)
]
