        ...
        if(nextProps.getEntityRet.success){
          ...
          try {
            this.setState({
              ...
              consultationFee:data.specialities.length!==0?data.specialities.services.length!==0?!!data.specialities[0].services[0].price?data.specialities[0].services[0].price[0]:'':'':'',
