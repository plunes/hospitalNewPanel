        ...
        return <div className="Header">
          <div>
            <nav className="navbar navbar-expand-lg navbar-light">
              <a className="navbar-brand" href="#"><img className="logo" src="/pluneslogo.png"  alt='No image available'/></a>
              {/* <div>
                ...
                <ul className="navbar-nav ml-auto">
                  <li className="nav2 nav-item">
                    <a className="nav-link HeaderLink" href = '/payment'>
                      <img className="sol-img" src="/payment.svg" alt='No image available'></img><span className="top-img">Payment</span> 
                    </a>
                  </li>
                  <li className="nav2 nav-item">
                    <div>
                      <a className=" nav-link HeaderLink" target="_blank" href="https://www.plunes.com/plockrapp">
                        <img className="sol-img" src="/plockerlogo.svg" alt='No image available'></img><span className="top-img">PLOCKR</span>
                      </a>
                    </div>
                  </li>
                  <li className="nav-item nav2" onClick = {this.handleClick}>
                    <a>
                      <div className="nav-link HeaderLink" ><img className="sol-img" src="/Notification.png" alt='No image available'/><span><span className="badge badge-danger NotifyNum">{this.props.notificationCount}</span><span style={{marginLeft:"8px"}}>Notification</span></span></div>
                    </a>
                  </li>
                  <li className="nav-item nav2">
                    <div className="dropdown">
                      <button className="btn dropdown-align HeaderProfileimg" type="button" data-toggle="dropdown">
                         <img className="sol-img2" src={this.props.user.imageUrl || '/profile.png'}  alt='No image available'/>{this.props.user.name}
